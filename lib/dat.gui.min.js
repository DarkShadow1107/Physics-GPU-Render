						...
						return (
							...
							c["default"].isUndefined(s.__step)
								? 0 === s.initialValue
									? (s.__impliedStep = 1)
									: (s.__impliedStep =
											Math.pow(10, Math.floor(Math.log(Math.abs(s.initialValue)) / Math.LN10)) / 10)
					...
					function t(n, o, a) {
						...
						return (
							...
							c["default"].bind(h.__input, "keydown", function (e) {
								13 === e.keyCode &&
									((m.__truncationSuspended = !0), this.blur(), (m.__truncationSuspended = !1), s());
							}),
							h.updateDisplay(),
					...
					U["default"].extend(n, {
						options: function (t) {
							if (arguments.length > 1) {
								...
								return (
									n.remove(),
									s(e, n.object, n.property, { before: o, factoryArgs: [U["default"].toArray(arguments)] })
								);
							}
					...
					return (
						...
						(e.prototype.layout = function () {
							(this.domElement.style.left =
								window.innerWidth / 2 - a["default"].getWidth(this.domElement) / 2 + "px"),
